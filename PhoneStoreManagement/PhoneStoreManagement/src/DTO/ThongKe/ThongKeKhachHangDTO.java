...
public class ThongKeKhachHangDTO {
    ...
    public ThongKeKhachHangDTO(int makh, String tenkh, int sohoadon, long tongtien) {
        this.makh = makh;
        this.tenkh = tenkh;
    ...
    public String toString() {
        return "ThongKeKhachHangDTO{" + "makh=" + makh + ", tenkh=" + tenkh + ", soluongphieu=" + sohoadon + ", tongtien=" + tongtien + '}';
    }
