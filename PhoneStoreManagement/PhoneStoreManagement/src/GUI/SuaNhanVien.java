...
public class SuaNhanVien extends javax.swing.JFrame {
    ...
    public SuaNhanVien(int ma,Main mainForm) {
       initComponents();
        this.ma = ma;
    ...
    loadThongTinNhanVien(); // Tự động load dữ liệu sản phẩm lên các field
    }
    ...
    NhanVienDTO nv = nvBUS.getNhanVienById(ma);

    if (nv != null) {
        txtMa.setText(String.valueOf(nv.getMaNhanVien()));
        txtTen.setText(nv.getHoTen());
        txtChucVu.setText(nv.getChucVu());       
        dateChooser.setDate(java.sql.Date.valueOf(nv.getNgayVaoLam()));      
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
       try {
        ...
        // Cập nhật khách hàng
        boolean updatedKH = nvBUS.suaNhanVien(nv);

        if (updatedKH) {
            JOptionPane.showMessageDialog(this, "Cập nhật khách hàng thành công!");
            mainForm.loadNhanVienToTable(); // Load lại bảng nếu có
